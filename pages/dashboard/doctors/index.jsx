          ...
          <div className="px-6 flex justify-between gap-2">
            ...
            >
              <CardHeader className="pb-3">
                <CardTitle>Doctors Field</CardTitle>
                <CardDescription className="max-w-lg text-gray-800 leading-relaxed mt-2">
                  In the Doctors Field, you can manage patient information, diagnose, provide treatment, and issue prescriptions. It serves as a comprehensive tool for doctors to effectively care for their patients.
                </CardDescription>
            ...
            >
              <CardHeader className="pb-3">
                ...
                <CardDescription className="max-w-lg text-balance leading-relaxed">
                  Unlock the extraordinary potential of artificial intelligence in diagnosing patients swiftly and accurately. From intricate medical analyses to specialized consultations across diverse fields, empower your healthcare journey with cutting-edge AI technology.
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Button onClick={() => {
                    window.location.href = '/dashboard/chat';
                  }}>Treat with AI</Button>
              </CardFooter>
            </Card>
          </div>
